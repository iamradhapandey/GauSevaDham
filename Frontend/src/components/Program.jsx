...
const Programs = () => {
  ...
  return (
    <section className="py-16 px-4 bg-[#FFEFE2]">
      ...
      <div className="relative border-l-2 border-[#F49CA1] max-w-4xl mx-auto space-y-16">
          ...
          >
            ...
            >
              <img
                ...
                className="rounded-lg shadow-md w-full h-[250px] object-cover cursor-pointer transform transition-transform duration-300 hover:scale-105"
              />
            </div>
      ...
      <div className="h-[40px] w-screen mt-12 flex justify-center items-center bg-[#FFEFE2]">
      <button onClick={() => navigate("/events")} className="bg-[#e414a2] text-white px-8 py-4 rounded-full text-lg font-medium shadow-lg hover:bg-[#8d1c69] transition duration-300 cursor-pointer">
        MORE EVENTS
      </button>
    </div>
