...
const Rigister = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-[#5C1E36] to-[#8C3F52] text-white px-4">
        ...
        <form className="flex flex-col gap-6 items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            <input
              ...
              className="bg-[#a04f61] placeholder-white/70 text-white px-6 py-3 rounded-full w-full sm:w-1/3 border-2 border-transparent focus:outline-none focus:ring-2 focus:ring-[#E87D7D] transition"
            />
            <input
              type="tel"
              name="mobile"
              ...
              value={form.mobile}
              onChange={handleChange}
              className="bg-[#a04f61] placeholder-white/70 text-white px-6 py-3 rounded-full w-full sm:w-1/3 border-2 border-red-500 focus:outline-none focus:ring-2 focus:ring-red-400 transition"
            />
            <input
              type="email"
              name="email"
          ...
          <button
            ...
            className={`px-10 py-4 rounded-full text-lg font-semibold transition-all duration-300 ${
              isChecked
                ? "bg-white text-[#a04f61] hover:bg-red-100"
