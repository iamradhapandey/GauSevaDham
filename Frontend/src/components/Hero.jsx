  ...
  export const Hero = () => {
    ...
    return (
<section className="relative min-h-screen bg-[#171725] overflow-hidden pt-[104px]">
{/* Background slideshow */}
...
{prevImage !== null && (
        ...
        <motion.h1
          ...
          <motion.button
            ...
            transition={{ delay: 1.8, duration: 0.6 }}
            onClick={() => navigate("/contact")}
            className="mt-8 bg-white text-[#a8247e] px-6 py-3 rounded-full text-lg font-semibold shadow-xl hover:bg-gray-100 transition"
          >
            Get Involved
          </motion.button>
        </div>
